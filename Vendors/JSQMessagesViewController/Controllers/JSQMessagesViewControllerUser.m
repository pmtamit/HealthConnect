...
#import "JSQMessagesViewControllerUser.h"
...
@interface JSQMessagesViewControllerUser () <JSQMessagesInputToolbarDelegate,
...
@implementation JSQMessagesViewControllerUser
@synthesize lbHeader ;
#pragma mark - Class methods

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([JSQMessagesViewControllerUser class])
                          bundle:[NSBundle mainBundle]];
}

+ (instancetype)messagesViewController
{
    return [[[self class] alloc] initWithNibName:NSStringFromClass([JSQMessagesViewControllerUser class])
                                          bundle:[NSBundle mainBundle]];
}
