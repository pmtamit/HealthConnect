...
//    }
    if (_AgeDelegate != nil && [_AgeDelegate conformsToProtocol:@protocol(AgeDelegate)]) {
        if ([_AgeDelegate respondsToSelector:@selector(AgeClick:)]) {
            [_AgeDelegate AgeClick:indexPath];
        }
    }
}
